...
<form>
    <div class="form-group">
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control radius" placeholder="Seu nome" aria-label="Username" aria-describedby="basic-addon1">
        </div>
        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text fa fa-envelope icon-form" id="basic-addon1"></span>
            </div>
            <input type="text" class="form-control radius" placeholder="E-mail" aria-label="Username" aria-describedby="basic-addon1">
        </div>
        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text fa fa-phone icon-form" id="basic-addon1"></span>
            </div>
            <input type="text" class="form-control radius" placeholder="Telefone" aria-label="Username" aria-describedby="basic-addon1">
        </div>
        <div class="input-group">
            ...
            <textarea class="form-control radius" aria-label="With textarea" placeholder="Sua mensagem"></textarea>
        </div>
    </div>
